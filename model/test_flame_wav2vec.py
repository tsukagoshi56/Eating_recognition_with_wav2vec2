...
class ASR(sb.core.Brain):
    def compute_forward(self, batch, stage):
        ...
        if stage == sb.Stage.VALID:
            ...
            for i, tokens in enumerate(p_tokens):
                ebd_flame.append(ids[i])
                ebd_flame.append(tokens[0].text_frames)
    ...
    def on_stage_end(self, stage, stage_loss, epoch):
        ...
        if stage == sb.Stage.VALID:
            ...
            if if_main_process():
                ...
                with open(self.hparams.test_ebd_flame_file, "w") as w:
                    for item in ebd_flame:
                         w.write(str(item) + '\n')
